...
public class BrokerReduceService implements ReduceService<BrokerResponseNative> {
  ...
  public BrokerResponseNative reduceOnDataTable(@Nonnull BrokerRequest brokerRequest,
    ...
    Map.Entry<ServerInstance, DataTable> entryWithDataRows = null;
    ...
    while (iterator.hasNext()) {
      ...
      // Cache an entry with data rows and an entry with data schema.
    ...
    if (!dataTableMap.isEmpty()) {
      ...
      List<String> droppedServers =
          removeConflictingResponses(entryWithDataRows.getValue().getDataSchema(), dataTableMap);
