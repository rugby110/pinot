...
public class BrokerResponseFactory {
  ...
  /**
   * Get a new empty broker response.
   */
   ...
   */
  public static BrokerResponse getNoTableHitBrokerResponse(@Nonnull ResponseType responseType) {
    if (responseType.equals(ResponseType.BROKER_RESPONSE_TYPE_NATIVE)) {
   ...
   */
  public static BrokerResponse getEmptyBrokerResponse(@Nonnull ResponseType responseType) {
    if (responseType.equals(ResponseType.BROKER_RESPONSE_TYPE_NATIVE)) {
